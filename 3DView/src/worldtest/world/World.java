...
public abstract class World extends AbstractAppState implements Closeable
{
    ...
    public World(App app, PhysicsSpace physicsSpace, int tileSize, int blockSize)
    {
        this.app = app;
    ...
    private boolean checkForNewChunks()
    {
        ...
        if (pending != null)
        {
            ...
            app.getTerrainNode().attachChild(pending.getChunk());
            physicsSpace.add(pending.getChunk());

            // add static rigid objects
            if (pending.getChunk().getStaticRigidObjectsNode() != null)
            {
                app.getTerrainNode().attachChild(pending.getChunk().getStaticRigidObjectsNode());
            ...
            {
                app.getTerrainNode().attachChild(pending.getChunk().getStaticNonRigidObjectsNode());
            }
            ...
            for (int x = topLx; x <= botRx; x++)
            {
                for (int z = topLz; z <= botRz; z++)
                {
                    ...
                    if (chunk != null)
                    {
                        ...
                        app.getTerrainNode().attachChild(chunk);
                        ...
                        if (chunk.getStaticRigidObjectsNode() != null)
                        {
                            app.getTerrainNode().attachChild(chunk.getStaticRigidObjectsNode());
                        ...
                        if (chunk.getStaticNonRigidObjectsNode() != null)
                        {
                            app.getTerrainNode().attachChild(chunk.getStaticNonRigidObjectsNode());
                        }
